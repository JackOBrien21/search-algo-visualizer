...
function App() {
  ...
  */
  ...
  // Will call appropriate search function
  useEffect(() => {
  ...
  // curr will be current node (not id)
  ...
  // returns true if there is an obstacle at id=id
  // false otherwise
  ...
  // given a node in the grid
  // will return a list of all valid neighbors
